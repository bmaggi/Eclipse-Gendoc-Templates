...
public class Utils
{
    ...
    public static List<IGendoc2Runner> getRunners(Object selectedObject)
    {
    	List<IGendoc2Runner> runners = new ArrayList<IGendoc2Runner>();
    	for (IGendoc2Runner runner : getAllRunners()) {
    		if (runner.getSelectionConverter().matches(selectedObject)) {
    			IFile selectedFile = runner.getSelectionConverter().getFile(selectedObject);
