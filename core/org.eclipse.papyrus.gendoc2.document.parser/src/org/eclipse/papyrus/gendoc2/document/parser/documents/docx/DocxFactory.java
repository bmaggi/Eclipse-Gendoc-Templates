...
public class DocxFactory implements DocumentFactory
{
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.papyrus.doc2model.documents.DocumentFactory#loadDocument(java.io .File)
     */
    ...
    {
        DocxDocument document = new DocxDocument(documentFile, configuration);
        return document;
    }
